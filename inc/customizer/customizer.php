...
function kairos_customize_preview_js() {
	wp_enqueue_script( 'kairos-customize-preview', get_template_directory_uri() . '/assets/js/customize-preview.min.js', array( 'customize-preview' ), '20191114', true );
}
...
function kairos_customizer_controls_js() {
	wp_enqueue_script( 'kairos-customizer-controls', get_template_directory_uri() . '/assets/js/customizer-controls.min.js', array(), '20200304', true );
}
...
function kairos_customizer_controls_css() {
	wp_enqueue_style( 'kairos-customizer-controls', get_template_directory_uri() . '/assets/css/customizer-controls.css', array(), '20200304' );
}
